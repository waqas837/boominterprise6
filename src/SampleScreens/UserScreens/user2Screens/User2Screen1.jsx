...
const User2Screen1 = () => {
  ...
  console.log("userID", userID.includes("user-1"));

  return (
    <>
      <div>
        {userID.includes("user-1") || userID.includes("user-2") ? (
          "Welcome to the screen User1 || User2 Screen1"
        ) : (
          <>
